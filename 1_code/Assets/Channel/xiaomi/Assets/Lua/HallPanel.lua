...
function HallPanel:ctor(call)
	...
	self.PhoneButton_btn.gameObject:SetActive(false)
	self.kffk_btn.gameObject:SetActive(false)
	...
	btn_map["right_top"] = {self.hall_btn_4, self.hall_btn_3, self.hall_btn_2, self.hall_btn_1,self.hall_btn_107,self.hall_btn_106,self.hall_btn_105}
...
function HallPanel:IsXiaoMiLowPlay()
	local b = MainModel.IsLowPlayer()

	self.MiniGameWaitPrefab.gameObject:SetActive(b)
	self.MiniGameWaitPrefab_1.gameObject:SetActive(b)
	self.MiniGameWaitPrefab_2.gameObject:SetActive(b)

	self.FishingMatch.gameObject:SetActive(b)
	self.TTL.gameObject:SetActive(not b)
	self.XYXXL.gameObject:SetActive(not b)
	self.SHXXL.gameObject:SetActive(not b)
	self.MINIGAME.gameObject:SetActive(not b)
	self.PhoneButton_btn.gameObject:SetActive(not b)
	self.kffk_btn.gameObject:SetActive(not b)
	self.duihuan_btn.gameObject:SetActive(not b)
	self.rw_btn.gameObject:SetActive(not b)
end
