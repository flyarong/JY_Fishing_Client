...
class PreProcessBuilderHuanLeBY_XiaoMi : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "xiaomi", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for xiaomi channel!");
...
class PostProcessBuilderHuanLeBY_XiaoMi : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for xiaomi channel!");
