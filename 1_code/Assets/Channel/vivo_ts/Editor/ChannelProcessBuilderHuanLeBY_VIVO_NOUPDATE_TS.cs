...
class PreProcessBuilderHuanLeBY_VIVO_NOUPDATE_TS : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "vivo_ts", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for vivo_ts channel!");

		PlayerSettings.applicationIdentifier = "com.changleyou.hlttby.vivo";
...
class PostProcessBuilderHuanLeBY_VIVO_NOUPDATE_TS : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for vivo_ts channel!");
