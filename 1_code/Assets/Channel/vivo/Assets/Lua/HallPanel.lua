...
function HallPanel:IsVivoLowPlay()
	if MainModel.IsLowPlayer() then
		self.MiniGameWaitPrefab.gameObject:SetActive(true)
		self.MiniGameWaitPrefab_1.gameObject:SetActive(true)
		self.TTL.gameObject:SetActive(false)
		self.XYXXL.gameObject:SetActive(false)
	else
		self.MiniGameWaitPrefab.gameObject:SetActive(false)
		self.MiniGameWaitPrefab_1.gameObject:SetActive(false)
		self.TTL.gameObject:SetActive(true)
		self.XYXXL.gameObject:SetActive(true)
	end
end
