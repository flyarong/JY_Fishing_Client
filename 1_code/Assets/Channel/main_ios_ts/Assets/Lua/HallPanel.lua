...
function HallPanel:OnMiniGameClick(go)
	ExtendSoundManager.PlaySound(audio_config.game.com_but_confirm.audio_name)
	GameManager.GotoSceneName("game_Fishing3DBossHall", {down_style={panel=self.MINIGAME.transform}})	
end
...
function HallPanel:OnJJBYClick()
	ExtendSoundManager.PlaySound(audio_config.game.com_but_confirm.audio_name)
	GameManager.GotoSceneName("game_FishFarm")
end

function HallPanel:OnTTLClick()
	ExtendSoundManager.PlaySound(audio_config.game.com_but_confirm.audio_name)
	GameManager.GotoSceneName("game_TTL", {down_style={panel=self.TTL.transform}})
end
