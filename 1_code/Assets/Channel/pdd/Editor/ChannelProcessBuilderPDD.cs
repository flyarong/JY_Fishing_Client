...
class PreProcessBuilderPDD : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "pdd", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for pdd channel!");

		PlayerSettings.applicationIdentifier = "com.changleyou.tthlby";
...
class PostProcessBuilderPDD : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for pdd channel!");
