...
class PreProcessBuilderCJJ : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "cjj", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for cjj channel!");

#if UNITY_IOS
		PlayerSettings.applicationIdentifier = "com.kashibuyi.cjj";
#else
		PlayerSettings.applicationIdentifier = "com.wuziqi.wzq";
#endif
...
class PostProcessBuilderCJJ : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for cjj channel!");
