...
class PreProcessBuilderHuanLeBY_YYB_NOUPDATE : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "yyb_ts", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for yyb_ts channel!");

		PlayerSettings.applicationIdentifier = "com.tencent.tmgp.hlttby";
...
class PostProcessBuilderHuanLeBY_YYB_NOUPDATE : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for yyb_ts channel!");
