...
function HallPanel:ctor(call)
	...
	btn_map["right_top"] = {self.hall_btn_share,self.hall_btn_4, self.hall_btn_3, self.hall_btn_2, self.hall_btn_1}
...
function HallPanel:RefreshBagGet()
	...
	local  function IsHaveBox( )
		local _box = {"prop_gej_xy","prop_gej_ss","prop_gej_cs",}
		for i=1,#_box do
			local _gej = GameItemModel.GetItemCount(_box[i])
			if _gej >0 then
				return true
			end
		end
