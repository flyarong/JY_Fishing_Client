...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(Transform))
            ...
            .AddExtendType(typeof(DOTweenExtend)),
        ...
        _GT(typeof(GameObject)).AddExtendType(typeof(ExtendDefine)),
		...
		_GT(typeof(ParticleSystem.Particle)),
        ...
        _GT(typeof(ComAnimatorEvent)),
        
        _GT(typeof(Color)),
        _GT(typeof(ShotSceneTools)),
        _GT(typeof(PolygonClick)),
        _GT(typeof(Dropdown)).AddExtendType(typeof(ExtendDefine)),
        ...
        _GT(typeof(InlineText)),

        // 无限循环滑动
        _GT(typeof(PoolObject)),
        _GT(typeof(LoopHorizontalScrollRect)),
        _GT(typeof(LoopScrollSendIndexSource)),
        _GT(typeof(LoopScrollPrefabSource)),
        _GT(typeof(LoopVerticalScrollRect)),
        _GT(typeof(ScrollIndexCallback)),

        _GT(typeof(ImageConversion)),
        _GT(typeof(SceneManager)),
        _GT(typeof(UnityEvent)),
        _GT(typeof(InlineText.HrefClickEvent)),        
        _GT(typeof(UnityEvent<float>)),
        _GT(typeof(UnityEvent<bool>)),
        _GT(typeof(UnityEvent<string>)),
        _GT(typeof(UnityEvent<int>)),
        _GT(typeof(UnityEvent<string,int>)),
        _GT(typeof(UnityEvent<PolygonClick>)),
		...
		_GT(typeof(GestureManager)),
		_GT(typeof(UniClipboard)),
        _GT(typeof(AppDefine)),
		_GT(typeof(ScannerQRCode)),
        //_GT(typeof(ExtendDefine)),

        _GT(typeof(UI2DSpriteAnimation)),
		_GT(typeof(UI2DImageAnimation)),
        _GT(typeof(PlayerPrefs)),
        _GT(typeof(EventTriggerListener)),
        _GT(typeof(PointerEventListener)),
        ...
        _GT(typeof(UnityEngine.UI.Image.FillMethod)),
