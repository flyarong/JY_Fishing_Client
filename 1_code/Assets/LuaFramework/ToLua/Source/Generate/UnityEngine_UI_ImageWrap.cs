...
public class UnityEngine_UI_ImageWrap
{
	...
	static int DOBlendableColor(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Graphic, UnityEngine.Color, float>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Image, UnityEngine.Color, float>(L, 1))
			{
				UnityEngine.UI.Image obj = (UnityEngine.UI.Image)ToLua.ToObject(L, 1);
				UnityEngine.Color arg0 = ToLua.ToColor(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int DOFade(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Graphic, float, float>(L, 1))
			{
				UnityEngine.UI.Image obj = (UnityEngine.UI.Image)ToLua.ToObject(L, 1);
