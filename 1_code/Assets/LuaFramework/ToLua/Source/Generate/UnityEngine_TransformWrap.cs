...
public class UnityEngine_TransformWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOMoveLocalBezier", DOMoveLocalBezier);
		L.RegFunction("DOMoveBezier", DOMoveBezier);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DOMoveLocalBezier(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 4)
			{
				...
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				DG.Tweening.Tweener o = obj.DOMoveLocalBezier(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				DG.Tweening.Tweener o = obj.DOMoveLocalBezier(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Transform.DOMoveLocalBezier");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DOMoveBezier(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 4)
			{
				...
				int arg1 = (int)LuaDLL.luaL_checknumber(L, 3);
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				DG.Tweening.Tweener o = obj.DOMoveBezier(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				byte arg3 = (byte)LuaDLL.luaL_checknumber(L, 5);
				DG.Tweening.Tweener o = obj.DOMoveBezier(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Transform.DOMoveBezier");
			}
		}
		catch (Exception e)
		{
