...
public class UnityEngine_Physics2DWrap
{
	...
	static int GetContacts(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Collider2D, UnityEngine.Collider2D[]>(L, 1))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Collider2D, UnityEngine.ContactPoint2D[]>(L, 1))
			{
				UnityEngine.Collider2D arg0 = (UnityEngine.Collider2D)ToLua.ToObject(L, 1);
				UnityEngine.ContactPoint2D[] arg1 = ToLua.ToStructArray<UnityEngine.ContactPoint2D>(L, 2);
				int o = UnityEngine.Physics2D.GetContacts(arg0, arg1);
			...
			else if (count == 4)
			{
				...
				UnityEngine.Collider2D arg1 = (UnityEngine.Collider2D)ToLua.CheckObject<UnityEngine.Collider2D>(L, 2);
				UnityEngine.ContactFilter2D arg2 = StackTraits<UnityEngine.ContactFilter2D>.Check(L, 3);
				UnityEngine.ContactPoint2D[] arg3 = ToLua.CheckStructArray<UnityEngine.ContactPoint2D>(L, 4);
	...
	static int get_autoSimulation(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.Physics2D.autoSimulation);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_autoSimulation(IntPtr L)
	{
		...
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			UnityEngine.Physics2D.autoSimulation = arg0;
			return 0;
		}
		catch (Exception e)
		{
