...
ext_require("Game.CommonPrefab.Lua.LWZBGuidePanel")
M.config = ext_require("Game.CommonPrefab.Lua.lwzb_game_config")
M.hall_config = ext_require("Game.CommonPrefab.Lua.lwzb_hall_config")
