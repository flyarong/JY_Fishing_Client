...
function HintPanel:ctor(type,msg,confirmCbk,cancelCbk,parent,title,prefab_name,parms)
    ...
    if (MainModel.myLocation == "game_DdzMatch" or MainModel.myLocation == "game_DdzMillion" or MainModel.myLocation == "game_MjMatchNaming" or MainModel.myLocation == "game_CityMatch" or
    ...
    elseif IsEquals(self.transform:Find("ImgTitle/Image")) and IsEquals(self.transform:Find("ImgTitle/Text")) then 
        self.transform:Find("ImgTitle/Image"):GetComponent("Image").sprite=GetTexture("ty_imgf_ts")
...
function HintPanel:InitUIMatch()
    ...
    self.title_img = self.UIEntity.transform:Find("ImgTitle"):GetComponent("Image")
    ...
    self.close_txt = self.UIEntity.transform:Find("ImgPopupPanel/close_btn/Text"):GetComponent("Text")
