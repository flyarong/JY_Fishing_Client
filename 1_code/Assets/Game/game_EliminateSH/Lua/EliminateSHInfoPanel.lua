...
--当武松技能触发了
--1,播放相关特效，2，将武松技能触发前，非鲁智深消灭 ， 获得金币乘以2
...
function M:ctor()
    ...
    self:AddMsgListener()
    self:InitUI()
    if not XXLSHPHBManager or not XXLSHPHBManager.CheckPermiss() then 
        self.gameObject.transform:Find("Help").transform.localPosition = Vector2.New(-81,-550)
    end
end
