...
M.time = {
    ...
    xc_bj_ys = 0.2,--消除金币普通暴击延时
    xc_bj_fd = 0.4,--消除暴击出现放大
    xc_bj_jg = 0.2,--消除暴击放大到缩小延时间隔
    xc_bj_sx = 0.1,--消除暴击出现缩小

    xc_jb_pt_bjb_ys = 0.2,--消除金币普通爆金币特效延时（爆金币的特效）
    xc_jb_bj_sz_fei_jg = 0.2,--消除金币暴击数字飞出延时
    xc_jb_pt_sz_fei_jg = 0.3,--消除金币普通数字飞出延时
    xc_jb_pt_sz_fd_jg = 0.02,--消除金币普通数字放大时间
    xc_jb_pt_sz_yd_sj = 0.3,--消除金币普通数字上移时间
