...
function M.shoot(_,data)
    ...
    if data.gun_id == 8 then
        ...
        data.bullet.prefab = "BulletPrefab_z_4"
        ...
        if data.level > 1 then
            ...
            data.bullet.prefab = "BulletPrefab_1"
        end
...
function M.on_fishing_dr_quit_room(_, data)
    if data.result == 0 then
        ...
        if MainModel.IsLowPlayer() then
            ...
            GameManager.GotoSceneName(GLC.bykp_back_scene or "game_MiniGame")
        end
    else
