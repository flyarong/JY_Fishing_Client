...
function basefunc.array_shuffle( array, iBegin, iEnd )
	assert( array )
	iBegin = iBegin or 1
	iEnd = iEnd or iBegin
	for i = iBegin, iEnd do
		local randomIdx = math.random( iBegin, iEnd )
		local temp = array[iBegin]
		array[iBegin] = array[randomIdx]
