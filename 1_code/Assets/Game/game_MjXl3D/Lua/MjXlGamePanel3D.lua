...
function MjXlGamePanel:Awake()
   ...
   self.ChangedeskButton.onClick:AddListener(function ()
    ...
    self.CloseButton.onClick:AddListener(function ()
        ExtendSoundManager.PlaySound(audio_config.game.com_but_cancel.audio_name)
        --if MjXlModel.data.model_status ~= MjXlModel.Model_Status.gaming or not MjXlModel.data.hu_data_map[MjXlModel.data.seat_num] or OperatorActivityLogic.CanLeaveGameBeforeEnd(true) then
