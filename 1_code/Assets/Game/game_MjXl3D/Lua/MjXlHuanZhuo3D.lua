...
function C:ctor(parent)
	...
	self.ChangedeskButton.onClick:AddListener(function ()
		...
		if MjXlModel.data.status ~= MjXlModel.Status.settlement and MjXlModel.data.status ~= MjXlModel.Status.gameover and not OperatorActivityLogic.CanLeaveGameBeforeEnd() then
