...
local game_sw_icon_config = require "Game.Common.game_sw_icon_config" -- 实物Icon配置
global_game_sw_icon_map = {}
...
require "Game.CommonPrefab.Lua.LWZBManager"
require "Game.CommonPrefab.Lua.FishFarmManager"
require "Game.CommonPrefab.Lua.CommonMiniGameManager"
...
function MainLogic.Init()
    ...
    global_game_sw_icon_map = {}
    for k,v in ipairs(game_sw_icon_config.config) do
        global_game_sw_icon_map[v.name] = v
    end
    ...
    LWZBManager.Init()
    FishFarmManager.Init()
    CommonMiniGameManager.Init()
...
function MainLogic.AssetGet(data)
    if data and _G["GameItemModel"] then
