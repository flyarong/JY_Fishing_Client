...
function ZPGAnimManager.PlayAppleAnim(objects,parent,callback)
    if not ZPGModel or not ZPGModel.data or not ZPGModel.data.winner then
        return
    end
    ...
    seq:OnKill(function()
        if ZPGModel.data and ZPGModel.data.apple_data and ZPGModel.data.apple_data.is_gold_coin and ZPGModel.data.apple_data.is_gold_coin == 1 then
