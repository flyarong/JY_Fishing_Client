...
function MjXzGamePanel:Awake()
   ...
   self.ChangedeskButton.onClick:AddListener(function ()
    ...
    self.CloseButton.onClick:AddListener(function ()
        ExtendSoundManager.PlaySound(audio_config.game.com_but_cancel.audio_name)
        --if MjXzModel.data.model_status ~= MjXzModel.Model_Status.gaming or not MjXzModel.data.hu_data_map[MjXzModel.data.seat_num] or OperatorActivityLogic.CanLeaveGameBeforeEnd(true) then
