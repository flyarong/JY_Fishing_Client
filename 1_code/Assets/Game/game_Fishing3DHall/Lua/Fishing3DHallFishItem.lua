...
Fishing3DHallFishItem = basefunc.class()
local C = Fishing3DHallFishItem
C.name = "Fishing3DHallFishItem"
...
function C:ctor(parent, data, panelSelf)
	...
	local obj = newObject("Fishing3DHallFishItem", parent)
