...
function MjXzFKGamePanel:OnShareClick()
    ...
    -- description = "平摊房费，" .. self.RuleText.text
    -- title = "麻将血战 房号：" .. MjXzFKModel.data.friendgame_room_no
    --url = "http://jingyu://www.jyhd919.cn?room_no=" .. MjXzFKModel.data.friendgame_room_no
    ...
    --     MjXzFKModel.data.friendgame_room_no

    -- 分享链接
    local shareLink = string.format(share_link_config.share_link[6].link[1], 
        MjXzFKModel.data.friendgame_room_no,
        self.RuleText.text,
...
function MjXzFKGamePanel:RefreshCenter()
    ...
    if data then
        ...
        if data.cur_race == 1 then
            if data.model_status == MjXzFKModel.Model_Status.wait_begin and data.model_status == MjXzFKModel.Model_Status.wait_join then
