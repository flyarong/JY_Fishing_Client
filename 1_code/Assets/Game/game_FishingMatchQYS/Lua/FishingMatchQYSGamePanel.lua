...
FishingMatchQYSGamePanel = basefunc.class()
-- 别名
FishingGamePanel = FishingMatchQYSGamePanel
FishingMatchGamePanel = FishingMatchQYSGamePanel
local C = FishingMatchQYSGamePanel
C.name = "FishingMatchQYSGamePanel"
...
function C:Awake()
	...
	self:AddMsgListener()
	-- 创建2DUI
	local ui2d = newObject("FishingMatchQYS2DUI")
