...
local function MakeLister()
    ...
    lister["fsqmg_all_info_test_response"] = this.on_fsmg_all_info_test_response

    lister["fsqmg_begin_msg"] = this.on_fsmg_begin_msg
    lister["fsqmg_enter_room_msg"] = this.on_fsmg_enter_room_msg
    lister["fsqmg_rank_msg"] = this.on_fsmg_rank_msg
    lister["fsqmg_match_discard_msg"] = this.on_fsmg_match_discard_msg
    lister["fsqmg_gameover_msg"] = this.on_fsmg_gameover_msg

    lister["fsqmg_barbette_info_change_msg"] = this.on_barbette_info_change_msg
    lister["fsqmg_money_supply_msg"] = this.on_fsmg_money_supply_msg
    lister["fsqmg_game_time_info_msg"] = this.on_fsmg_game_time_info_msg
    lister["fsqmg_get_one_event"] = this.on_fsmg_get_one_event
    lister["fsqmg_match_revive_msg"] = this.on_fsmg_match_revive_msg
    lister["fsqmg_barrage_broadcast"] = this.on_fsmg_barrage_broadcast
end
...
function FishingMatchModel.SendAllInfo()
    ...
    Network.SendRequest("fsqmg_all_info_test", nil, "")
end
-- 断线重连数据 all_info
function FishingMatchModel.on_fsmg_all_info_test_response(_, data)
    ...
    if data.players_info then
        ...
        m_data.players_info[1].prop_fish_lock = MainModel.UserInfo.prop_3d_fish_lock or 0
        m_data.players_info[1].prop_fish_frozen = MainModel.UserInfo.prop_3d_fish_frozen or 0
    ...
    if data.assets then
        for k1, v1 in ipairs(data.assets) do
            ...
            elseif v1.value == "sub_score" then
                m_data.cache_grades = tonumber(v1.value)
            end
        end
    end
...
function FishingMatchModel.GetBuySkillToList()
    local cfg = FishingManager.GetCurQysToConfig()
