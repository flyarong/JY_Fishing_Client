...
function C:ctor(parent, panelSelf)
    ...
    self.buy_item_hf = {
    	...
    	prop_fish_secondary_bomb_2 = 1000000,
    	prop_fish_super_bomb_2 = 5000000,
    	prop_fish_secondary_bomb_3 = 10000000,
    	prop_fish_super_bomb_3 = 30000000,
    }
...
function C:MyRefresh()
    ...
    self.min_len = 0
    -- 浅水湾 体验场 没有常驻原子弹
    if FishingModel.data.game_id ~= 4 and FishingModel.data.game_id ~= 1 then--todo
