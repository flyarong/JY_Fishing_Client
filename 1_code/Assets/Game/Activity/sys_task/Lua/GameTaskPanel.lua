...
function GameTaskPanel:UpdateHB()
    self.sv_item_list[GameTaskModel.TaskType.game].right_txt.text = "今日可领取" .. StringHelper.ToRedNum(GameTaskModel.data.hb_data.upper_limit ) .. "红包"
end
