...
local act_task_icon_map = {
	obj_fish_free_bullet = "by_imgf_mfzd",
	obj_fish_crit_bullet = "by_imgf_bjsk1",
	obj_fish_power_bullet = "by_imgf_wlts1",
	obj_fish_3d_free_bullet = "by_imgf_mfzd",
	obj_fish_3d_power_bullet = "by_imgf_bjsk1",
	obj_fish_3d_crit_bullet = "by_imgf_wlts1",
}
...
function C:MyRefresh()
	...
	if self.data then
	    ...
	    if self.data.fix_award_data then
	    	dump(self.data.fix_award_data, "<color=red>IIIIIIIIIIIIIIIIIIIIIII</color>")
	    	...
	    	if not item_cfg then
	    		dump(at_key, "<color=red>at_key IIIIIIIIIIIIIIIIIIIIIII</color>")
	    		return
	    	end
	    	local numtxt
