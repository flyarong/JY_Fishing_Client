...
Act_038_S12LHSJBPanel = basefunc.class()
local C = Act_038_S12LHSJBPanel
C.name = "Act_038_S12LHSJBPanel"
...
function C:MakeLister()
    self.lister = {}
	self.lister["act_038_s12lhsjb_base_info_get"] = basefunc.handler(self,self.act_038_s12lhsjb_base_info_get)
...
function C:act_038_s12lhsjb_base_info_get()	
	self:onMyInfoGet()
end
