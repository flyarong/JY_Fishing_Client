...
ActLotteryBaseManager = {}

local M = ActLotteryBaseManager
M.key = "act_lottery_base_manager"
GameButtonManager.ExtLoadLua(M.key, "LotteryBaseManager")
local lister
