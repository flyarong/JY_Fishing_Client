...
Act_064_XYFDPanel = basefunc.class()
local C = Act_064_XYFDPanel
C.name = "Act_064_XYFDPanel"
...
function C:MyRefresh()
    ...
    self.now_txt.text = self.config.price_now .. "元购买"
    self.ori_txt.text = self.config.price_ori .. "元购买"
end
