...
Act_013_DLFLEnterPrefab = basefunc.class()
local C = Act_013_DLFLEnterPrefab
C.name = "Act_013_DLFLEnterPrefab"
...
function C:MakeLister()
	...
	self.lister["Panel_back_dlfl"] = basefunc.handler(self,self.on_panel_back)
	--self.lister["model_dlfl_EnterPrefab_move"] = basefunc.handler(self,self.on_model_dlfl_EnterPrefab_move)
