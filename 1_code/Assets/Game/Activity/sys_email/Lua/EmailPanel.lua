...
function EmailPanel:ctor()
	...
	self.AwardRect = self.transform:Find("RightBG/Email/BG/ScrollView/Viewport/Content/AwardRect")
	self.AwardPrefab = self.transform:Find("RightBG/Email/BG/ScrollView/Viewport/Content/AwardRect/AwardPrefab")
	self.AwardNode = self.transform:Find("RightBG/Email/BG/ScrollView/Viewport/Content/AwardRect/AwardNode")
