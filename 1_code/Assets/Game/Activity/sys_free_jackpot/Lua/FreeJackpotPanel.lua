...
function FreeJackpotPanel:UpdateCountdown()
    ...
    if all_info.last_week_my_award and all_info.last_week_my_award > 0 then
        self.cur_bonus_txt.text = "奖池" .. StringHelper.ToRedNum((all_info.last_week_award - self.change_money) ) .. "元"
    else
        self.cur_bonus_txt.text = "奖池" .. StringHelper.ToRedNum((all_info.cur_week_award - self.change_money) ) .. "元"
    end
end
...
function FreeJackpotPanel:InitUI()
    ...
    if data.last_week_my_award and data.last_week_my_award > 0 then
        self.cur_bonus_txt.text = "奖池" .. StringHelper.ToRedNum((data.last_week_award - self.change_money) ) .. "元"
    else
        self.cur_bonus_txt.text = "奖池" .. StringHelper.ToRedNum((data.cur_week_award - self.change_money) ) .. "元"
    end
