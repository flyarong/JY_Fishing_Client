...
SYSXY_EnterPrefab = basefunc.class()
local C = SYSXY_EnterPrefab
C.name = "SYSXY_EnterPrefab"
...
function C:ctor(parent, cfg)
	...
	local obj = newObject("sys_xy_btn", parent)
...
function C:UpdateRedHit()
	local state = SYSXYManager.GetHintState()
