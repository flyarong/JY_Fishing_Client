-- 创建时间:2020-10-22
-- Panel:BY3DPHBRightItemBase_shtxb
--[[
 *      ┌─┐       ┌─┐
 *   ┌──┘ ┴───────┘ ┴──┐
 *   │                 │
...
BY3DPHBRightItemBase_shtxb = basefunc.class()
local C = BY3DPHBRightItemBase_shtxb
C.name = "BY3DPHBRightItemBase_shtxb"
...
function C:InitUI()
	...
	if self.data.rank == 1 then
		...
		self.tips_txt.text = "在3D捕鱼中使用，可消灭目标鱼，随机获得600-1200万金币"
	...
	elseif self.data.rank == 3 then
		...
		self.tips_txt.text = "在3D捕鱼中使用，可消灭目标鱼，随机获得300-600万金币"
	else
		...
		self.tips_txt.text = "在3D捕鱼中使用，可消灭目标鱼，随机获得60-120万金币"
	end
