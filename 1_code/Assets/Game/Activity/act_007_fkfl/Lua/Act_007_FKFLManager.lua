...
local lister
local permisstions = {
    "actp_own_task_p_free_player_task",
    "actp_own_task_p_stingy_player_task",
    "actp_own_task_p_vip_level_low_task",
    "actp_own_task_p_vip_level_middle_task",
    "actp_own_task_p_vip_level_high_task",
}
-- 是否有活动
function M.IsActive()
    -- 活动的开始与结束时间
