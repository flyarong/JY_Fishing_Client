...
local str = {
    sh_xxl = 1, sg_xxl = 2, by = 3, cs_xxl = 4, zjd = 5
}
local mask_img = {
    "fkfl_btn_shxxl_1", "fkfl_btn_sgxxl_1", "fkfl_btn_jjby_1", "fkfl_btn_csxxl_1", "fkfl_btn_qql_1"
}
...
function C:CheakIsHadChoose()
    ...
    for i = 1, #base do
        ...
        if data and (data.other_data_str and not (data.now_lv == #M.GetTaskConfig()[i] and data.need_process == data.now_process )) then
