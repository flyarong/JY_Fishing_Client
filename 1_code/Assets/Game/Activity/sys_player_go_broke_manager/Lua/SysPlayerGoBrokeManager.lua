...
SysPlayerGoBrokeManager = {}

local M = SysPlayerGoBrokeManager
M.key = "sys_player_go_broke_manager"
GameButtonManager.ExtLoadLua(M.key, "OnPlayerGoBrokeManager")
