...
Act_027_QYZLEnterPrefab = basefunc.class()
local C = Act_027_QYZLEnterPrefab
C.name = "Act_027_QYZLEnterPrefab"
...
function C:ctor(parent)
	...
	local obj = newObject("Act_027_QYZLEnterPrefab", parent)
