...
SYSByHKSGameInfoPrefab = basefunc.class()
local C = SYSByHKSGameInfoPrefab
C.name = "SYSByHKSGameInfoPrefab"
...
function C:ctor(parent)
    ...
    local obj = newObject("SYSByPmsGameInfoPrefab", parent)
...
function C:InitUI()
    ...
    Event.Brocast("global_select_top_index_msg",{gotoui = M.key,goto_scene_parm = "bytop_hks"})
...
function C:RefreshScore()
    self.score_txt.text = "" .. (M.GetCurScore() / 100)
end
...
function C:on_EnterClick()
    SYSByPmsGameRankPanel_PM.Create()
end