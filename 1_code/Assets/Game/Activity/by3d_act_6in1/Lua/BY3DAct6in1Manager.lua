...
local function MakeLister()
    ...
    lister["nor_fishing_3d_6in1_lottery_response"] = this.on_nor_fishing_3d_6in1_lottery_response
end
...
function M.RequestLottery()
    Network.SendRequest("nor_fishing_3d_6in1_lottery", nil, "抽奖")
...
function M.on_nor_fishing_3d_6in1_lottery_response(_, data)
    dump(data, "<color=red>on_nor_fishing_3d_6in1_lottery_response</color>")
