...
function C:MakeLister()
    ...
    self.lister["model_query_vip_base_info_response"] = basefunc.handler(self, self.MyRefresh)
end
...
function C:MyRefresh(  )
    ...
    VIPManager.set_vip_text(self.cur_vip_txt)
    if self.data.vip_level < #self.cfg then 
        local now_process
        local need_process
