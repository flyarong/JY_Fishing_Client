    ...
    if M.IsActive() then 
        if data and data.panelSelf then 
            ...
            local func = function () --将切换图片的操作加在之前的切换程序之后
                PS.modeIcon_img.sprite = GetTexture(PS.is2EggMode and "zjd_btn_ptms2" or "zjd_btn_nsms2")
                PS.modebtn_img.sprite = GetTexture(PS.is2EggMode and "zjd_btn_ptms" or "zjd_btn_nsms") 
