...
M.fishing_match_hall_config = GameButtonManager.ExtLoadLua(M.key, "fishing_match_hall_config")

GameButtonManager.ExtLoadLua(M.key,"FishingManager")
HotUpdateConfig("Game.CommonPrefab.Lua.GameFishing3DManager")
