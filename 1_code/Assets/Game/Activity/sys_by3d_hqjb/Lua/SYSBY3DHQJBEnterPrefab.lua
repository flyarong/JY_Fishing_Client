...
SYSBY3DHQJBEnterPrefab = basefunc.class()
local C = SYSBY3DHQJBEnterPrefab
C.name = "SYSBY3DHQJBEnterPrefab"
local M = SYSBY3DHQJBManager
...
function C:InitUI()
	...
	self.game_btn_pre = GameButtonPanel.Create(btn_map, "hqjb_config", self.transform)
	self.game_enter_cfg = GameButtonManager.GetGameEnterCfgByType("hqjb_config")
