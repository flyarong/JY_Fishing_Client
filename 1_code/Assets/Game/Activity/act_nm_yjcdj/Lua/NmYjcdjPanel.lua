...
NmYjcdjPanel = basefunc.class()
local C = NmYjcdjPanel
C.name = "NmYjcdjPanel"
--配置相关
local config = NmYjcdjManager.config
--排行榜相关
--改动数据相关
...
local LotteryStr = "积分"
local His_Prefab = "CommonlotteryinfoPrefab2"
-------------------
...
function C:InitUI()
	...
	self.time_txt.text = "12月26日07:30 - 12月31日23:59:59"
end
...
function C:ReFreshInfo(_, data)
	...
	self.expend_txt.text = self.need_credits..LotteryStr
