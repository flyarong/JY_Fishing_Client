...
function C:MyRefresh()
	...
	self.hb_txt.text = self.hb_value .. "福利券"
	self.zshb_txt.text = math.floor(self.hb_value / 2) .. " 福利券"
	self.hint_info_hb_txt.text = math.floor(self.hb_value / 2) .. " 福利券赠礼已存入新手福利券中~"
	self.hint_info_txt.text = "捕鱼过程中，发炮可以提高福利券金额，福利券金额<color=#FFE086FF>满 " .. self.hb_value .. " 可领取</color>。\n使用炮的倍数越高，福利券金额积攒越快，任务<color=#FFE086FF>时间有限</color>，请抓紧完成哟~"
	if state == 0 then
