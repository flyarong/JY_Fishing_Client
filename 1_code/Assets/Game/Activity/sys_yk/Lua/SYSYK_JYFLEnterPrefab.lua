    ...
    if SYSYKManager.IsLJ == true then
        ...
        if not SYSYKManager.IsBuy then
            ...
            if not SYSYKManager.IsBuy2 and SYSYKManager.CanBuy2 then
                ...
                self.get_btn.transform:GetComponent("Image").sprite = GetTexture("ty_btn_hui")
            end
        end
    end
end
