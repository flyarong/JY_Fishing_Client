...
local gift_map = {
  ...
  title_txt = {"60万鱼币","180万鱼币","480万鱼币"},
  tips = {"加赠8万鱼币","加赠12万鱼币","加赠38万鱼币"},
  btn_text = {"6元领取","18元领取","48元领取"},
  }, 

  [2] = {gift_ids={10052, 10053, 10054}, idx="2",
  title_txt = {"480万鱼币","980万鱼币","1980万鱼币"},
  tips = {"加赠38万鱼币","加赠68万鱼币","加赠158万鱼币"},
  btn_text = {"48元领取","98元领取","198元领取"},
  }, 
  

  [3] = {gift_ids={10055, 10056, 10057}, idx="3",
  title_txt = {"1980万鱼币","4980万鱼币","9980万鱼币"},
  tips = {"加赠158万鱼币","加赠348万鱼币","加赠708万鱼币"},
...
function C:OnQueryStatusResponse()
	...
	for i=1,#gift_map[self.tag].gift_ids do
		...
		self["title"..i.."_txt"].text = gift_map[self.tag].title_txt[i]
