...
BYBossTSManager = {}
local M = BYBossTSManager
M.key = "by_bossts"
GameButtonManager.ExtLoadLua(M.key, "BYBossTSEnterPrefab")
...
function M.GotoUI(parm)
    if parm.goto_scene_parm == "enter" then
        return BYBossTSEnterPrefab.Create(parm)
    else
...
function M.InitUIConfig()
    ...
    this.UIConfig.game_map[2] = {fish_id = 25, icon="3dby_icon_jc", name="3dby_img_zcbc"}
    this.UIConfig.game_map[3] = {fish_id = 47, icon="3dby_icon_sy", name="3dby_img_shks"}
    this.UIConfig.game_map[4] = {fish_id = 48, icon="3dby_icon_ey", name="3dby_img_bzey"}
    this.UIConfig.game_map[5] = {fish_id = 49, icon="3dby_icon_zy", name="3dby_img_bzhm"}
end
...
function M.GetConfigByGameID(id)
    return this.UIConfig.game_map[id]
end
