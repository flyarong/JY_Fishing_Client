...
Act_062_CZLBPanel = basefunc.class()
local C = Act_062_CZLBPanel
local M = Act_062_HGHDManager
C.name = "Act_062_CZLBPanel"
C.item_name = "Act_062_CZLBItem"
...
function C:InitUI()
	self:InitItemPrefab()
	self:MyRefresh()
	CommonTimeManager.GetCutDownTimer(M.GetEndTime(), self.remain_txt)
...
local BoxTip = {
	[1] = {"稀有宝箱", "重阳祈福活动期间开启，最高可得500福利券！"},
	[2] = {"稀有宝箱", "重阳祈福活动期间开启，最高可得500福利券！"},
	[3] = {"史诗宝箱", "重阳祈福活动期间开启，最高可得1000福利券！"},
	[4] = {"传说宝箱", "重阳祈福活动期间开启，最高可得2000福利券！"},
}
