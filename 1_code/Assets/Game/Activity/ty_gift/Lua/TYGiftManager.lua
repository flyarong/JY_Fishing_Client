...
function M.get_giftkey_by_cfg(gift_key)
    if type(gift_key) == "table" and gift_key.gift_key then
        gift_key = gift_key.gift_key
    end
...
function M.InitUIConfig()
    ...
    for k,v in pairs(game_gift_style_config.config) do
