...
GameButtonManager.ExtLoadLua(M.key, "GameShop3YuanPanelInAct")
local lister
...
function M.GotoUI(parm)
    ...
    elseif parm.goto_scene_parm == "panel3" then
        return GameShop3YuanPanel.Create(nil,parm.backcall)
    elseif parm.goto_scene_parm=="panel3_in_act" then
        return GameShop3YuanPanelInAct.Create(parm.parent)
    else
