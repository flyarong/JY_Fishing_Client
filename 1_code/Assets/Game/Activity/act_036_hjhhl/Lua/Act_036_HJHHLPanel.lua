...
Act_036_HJHHLPanel = basefunc.class()
local C = Act_036_HJHHLPanel
C.name = "Act_036_HJHHLPanel"
local M = Act_036_HJHHLManager
C.instance = nil

local help_info1 = {
"1.活动时间：11月24日8:00~11月30日23:59:59",
"2.活动期间，玩所有游戏都有几率获得火鸡道具，积累火鸡道具可兑换奖励",
"3.活动结束后，所有的火鸡道具将统一清除，请及时进行奖励兑换",
...
function C:CreateItemPrefab()
	...
	for i=1,#self.cur_data do
		local pre = Act_036_HJHHLItemBase.Create(self.Content.transform,self.cur_data[i])
		if pre then
