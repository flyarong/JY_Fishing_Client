...
function C:InitUI()
	EventTriggerListener.Get(self.look_btn.gameObject).onClick = basefunc.handler(self, self.OnLookClick)
...
function C:OnLookClick()
	GameButtonManager.RunFun({gotoui = "sys_tgxt",goto_scene_parm = "panel"},"GotoUI")
end