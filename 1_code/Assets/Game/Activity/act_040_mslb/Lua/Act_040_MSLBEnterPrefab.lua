...
Act_040_MSLBEnterPrefab = basefunc.class()
local C = Act_040_MSLBEnterPrefab
C.name = "Act_040_MSLBEnterPrefab"
...
function C:MakeLister()
	...
	self.lister["Panel_back_mslb"] = basefunc.handler(self,self.on_panel_back)
	--self.lister["model_mslb_EnterPrefab_move"] = basefunc.handler(self,self.on_model_mslb_EnterPrefab_move)
