...
local award_data = {
	[1] = {[1] = {info = "李逵出现1次",award_img = "pay_icon_gold2",not_award_img = "hhsl_icon_gold1",award_txt = "1000金币"},
		 [2] =	{info = "李逵出现3次",award_img = "pay_icon_gold3",not_award_img = "hhsl_icon_gold2",award_txt = "3000金币"}	
	},
	[2] = {[1] = {info = "武松出现1次",award_img = "pay_icon_gold2",not_award_img = "hhsl_icon_gold1",award_txt = "1000金币"},
		 [2] =	{info = "武松出现3次",award_img = "pay_icon_gold3",not_award_img = "hhsl_icon_gold2",award_txt = "3000金币"}	
	},
	[3] = {[1] = {info = "宋江出现1次",award_img = "pay_icon_gold2",not_award_img = "hhsl_icon_gold1",award_txt = "1000金币"},
		 [2] =	{info = "宋江出现3次",award_img = "pay_icon_gold3",not_award_img = "hhsl_icon_gold2",award_txt = "3000金币"}	
	},
	[4] = {[1] = {info = "鲁智深出现1次",award_img = "pay_icon_gold2",not_award_img = "hhsl_icon_gold1",award_txt = "1000金币"},
		 [2] =	{info = "鲁智深出现3次",award_img = "pay_icon_gold3",not_award_img = "hhsl_icon_gold2",award_txt = "3000金币"}	
	}
}
local left = -364.87
local right = -1095
