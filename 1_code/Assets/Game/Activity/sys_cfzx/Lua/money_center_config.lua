return {
	...
	tglb=
	{
		[1]=
		{
			...
			price = 19900,
			name = "金猪礼包",
			desc = "5元×40次红包任务 10张千元赛门票 1张万元赛门票 18万金币 30天记牌器",
			icon = "hall_btn_gift4",
			order = 2,
			on_off = 1,
			not_buy_show = 1,
			title = "在三星场以上对局8次",
			award = "奖励：<color=#ED8813FF><size=26>6.66</size></color>红包",
			gotoUI = {"free_hall",},
		...
		[2]=
		{
			...
			not_buy_show = 1,
			title = "在三星场以上对局8次",
			award = "奖励：<color=#ED8813FF><size=26>5</size></color>红包",
			gotoUI = {"free_hall",},
			get_end_tips = "您当日奖励已领取，请明日6点再来",
			over_tips = "您已领满了40次奖励，邀请好友还可以领奖金哦！",
		},
		...
		[4]=
		{
			...
			price = 49900,
			name = "新金猪礼包2",
			desc = "600万金币 10张千元赛门票 3张万元赛门票",
			icon = "hall_btn_jzlb2",
			order = 3,
			on_off = 1,
			not_buy_show = 1,
			title = "每日领取奖励",
			award = "奖励：<color=#ED8813FF><size=26>20万</size></color>金币",
			gotoUI = {"free_hall",},
			get_end_tips = "您当日奖励已领取，请明日6点再来",
		...
		[6]=
		{
			...
			price = 9900,
			name = "vip礼包",
			desc = "10张千元赛门票（参与10场无论输赢返利100红包）",
			icon = "hall_btn_gift14",
			order = 1,
			on_off = 1,
			not_buy_show = 1,
			title = "成功参与一次千元大奖赛",
			award = " 奖励：<color=#ED8813FF><size=26>10</size></color>福利券",
			remain = "剩余领取次数:%s/%s",
		...
		[7]=
		{
			...
			award = "奖励：<color=#ED8813FF><size=26>5</size></color>福利券",
			remain = "剩余领取次数:%s/%s",
