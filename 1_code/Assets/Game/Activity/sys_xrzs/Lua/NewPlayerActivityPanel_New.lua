...
NewPlayerActivityPanel_New = basefunc.class()
local C = NewPlayerActivityPanel_New
C.name = "NewPlayerActivityPanel_New"
--配置相关
...
function C:OnButtonClick()
	...
	function()
		...
		if self.NoStart_By_Anim == true then
			-- dump(SYSXRZSManager.IsCanLottery(),"<color=red>4444444444444444444444</color>")
			if SYSXRZSManager.IsCanLottery() then
