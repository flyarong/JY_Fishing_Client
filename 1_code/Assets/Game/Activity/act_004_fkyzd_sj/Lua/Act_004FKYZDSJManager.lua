...
Act_004FKYZDSJManager = basefunc.class()
local M = Act_004FKYZDSJManager
M.key = "act_004_fkyzd_sj"
local config = GameButtonManager.ExtLoadLua(M.key, "act_004_fkyzd_sj_config")
local lister
...
function M.IsActive()
    ...
    -- 对应权限的key
    local _permission_key = "actp_own_task_p_cumulative_recharge"
