...
SysItemManager = {}
local M = SysItemManager
M.key = "sys_item_manager"
M.item_config = GameButtonManager.ExtLoadLua(M.key, "item_config")
GameButtonManager.ExtLoadLua(M.key, "GameItemModel")
GameButtonManager.ExtLoadLua(M.key, "GameItemLogic")
local lister
