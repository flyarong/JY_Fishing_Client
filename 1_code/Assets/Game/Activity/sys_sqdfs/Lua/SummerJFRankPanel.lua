...
SummerJFRankPanel = basefunc.class()
local C = SummerJFRankPanel
C.name = "SummerJFRankPanel"
local config
...
function C:RefreshRankInfo()
	Network.SendRequest("query_rank_data",  {rank_type = "national_day_lottery_rank",page_index = self.data.query_index},"请求数据",function(data)
