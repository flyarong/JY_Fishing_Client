...
HQYDListPanel = basefunc.class()
local C = HQYDListPanel
C.name = "HQYDListPanel"
local Page_Index  =  1
function C.Create()
	return C.New()
end
...
function C:ctor()
	...
	self:AddMsgListener()
	self:InitUI()
	Network.SendRequest("common_lottery_query_award_logs",{page_index = Page_Index,lottery_type = "happy_new_year_2020_box"})
end
