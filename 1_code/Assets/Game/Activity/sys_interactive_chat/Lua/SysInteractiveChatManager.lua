...
SysInteractiveChatManager = {}
local M = SysInteractiveChatManager
M.key = "sys_interactive_chat"
M.config = GameButtonManager.ExtLoadLua("sys_interactive_player", "player_Interaction")
GameButtonManager.ExtLoadLua(M.key, "GameSpeedyLogic")
GameButtonManager.ExtLoadLua(M.key, "GameSpeedyModel")
GameButtonManager.ExtLoadLua(M.key, "GameSpeedyPanel")
GameButtonManager.ExtLoadLua(M.key, "GameSpeedyPrefab")
local lister
