...
function ShatterGoldenSale:InitRect(hammer_idx)
	...
	if hammer_idx == 3 then
		self.icon_img.sprite = GetTexture("qql_xsfl_zjd_icon16")
	else
		self.icon_img.sprite = GetTexture("qql_xsfl_zjd_icon17")
	end
