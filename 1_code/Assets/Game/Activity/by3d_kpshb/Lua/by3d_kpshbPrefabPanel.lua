...
function C:MyRefresh()
	...
	local cfg = BY3DKPSHBManager.GetConfigByGameID(id, BY3DKPSHBManager.GameType.GT_3D)
	if cfg then
	...
	if BY3DKPSHBManager.IsRedGetReachMax(id, BY3DKPSHBManager.GameType.GT_3D) then
