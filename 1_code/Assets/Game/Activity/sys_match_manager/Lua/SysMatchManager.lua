...
M.match_game_type_config = GameButtonManager.ExtLoadLua(M.key, "match_game_type_config")
M.match_game_award_config = GameButtonManager.ExtLoadLua(M.key, "match_game_award_config")
GameButtonManager.ExtLoadLua(M.key, "GameMatchLogic")
GameButtonManager.ExtLoadLua(M.key, "GameMatchModel")
local lister
