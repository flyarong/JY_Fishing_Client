...
Act_026_LMLHItemBase = basefunc.class()
local C = Act_026_LMLHItemBase
C.name = "Act_026_LMLHItemBase"
...
function C:InitUI()
	...
	local pre
	pre = self.transform:Find("top")
	pre = pre.transform:Find("GameObject")
	pre = pre.transform:Find("Text (1)"):GetComponent("Text")
	pre.text = "金币"
