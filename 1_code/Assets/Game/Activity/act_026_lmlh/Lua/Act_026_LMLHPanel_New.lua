...
Act_026_LMLHPanel_New = basefunc.class()
local C = Act_026_LMLHPanel_New
C.name = "Act_026_LMLHPanel_New"
...
function C:InitUI()
	...
	local pre = self.transform:Find("Text"):GetComponent("Text")
	pre.text = "充值商城中每日首次购买金币，必得爱心！"
...
function C:CreateItemPrefab()
	...
	for i=1,#self.cur_data do
		local pre = Act_026_LMLHItemBase.Create(self.Content.transform,self.cur_data[i])
		if pre then
...
local help_info = {
"1.活动时间：8月25日7:30-8月31日23:59:59",
"2.玩小游戏不论输赢，都有机会获得爱心，游戏场次越高，获得爱心的概率越高。",
"3.购买表白礼包或在充值商城中每日首次购买金币，必得爱心。",
"4.每个浪漫礼盒每天可开启的数量有限，请及时使用您的爱心，活动结束后所有爱心清零。",
}
