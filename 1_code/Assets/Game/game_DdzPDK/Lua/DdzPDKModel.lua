...
function DdzPDKModel.on_fg_all_info(proto_name, data)
    ...
    if m_data then
        ...
        if OperatorActivityModel.IsActivated(DdzPDKModel.baseData.game_id, ActivityType.Consecutive_Win) and m_data.model_status == DdzPDKModel.Model_Status.gameover then
