...
function C:Hupai(data)
	...
	ParticleManager.MJHuPaiAni(self.player.uiPos)
...
function C:RefreshHuPai(data)
	...
	-- self.hpImg = ParticleManager.MJHuPai(self.player.uiPos, huType, huIdx, huPai, self.transform)
...
function C:ShowPoChan()
	...
	self.hpImg = ParticleManager.MJHuPai(self.player.uiPos, "pochan", 1, 11, self.transform)
end
