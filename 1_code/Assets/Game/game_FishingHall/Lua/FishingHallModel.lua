...
function FishingHallModel.GetGameIDToConfig(game_id)
...
function FishingHallModel.CheckRapidBeginGameID()
    ...
    local gameCfg = FishingHallModel.GetGameIDToConfig(gametypeid)
    if not gameCfg or gameCfg.isOnOff == 0 then
        PlayerPrefs.SetInt(FishingHallModel.FishRapidBeginKey, 2)
        gameCfg = FishingHallModel.GetGameIDToConfig(2)
    end
    return gameCfg
end
