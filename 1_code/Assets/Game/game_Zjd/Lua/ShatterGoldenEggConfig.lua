return {
	...
	extra2eggs = {
		[1] = {
			base_money = 10000,
			auto_select_max_money = 10000 * 10,
		},
		[2] = {
			base_money = 200000,
			auto_select_max_money = 200000 * 10,
		},
		[3] = {
			base_money = 1000000,
			auto_select_max_money = 1000000 * 10 ,
		},
		[4] = {
			base_money = 5000000,
			auto_select_max_money = 5000000 * 10,
		},
		-- [5] = {
		-- 	base_money = 240000,
		...
		-- [9] = {
		-- 	base_money = 5120000,
		-- 	auto_select_max_money = 5120000 * 10 ,
		-- },
		-- [10] = {
		-- 	base_money = 10240000,
		-- 	auto_select_max_money = 10240000 * 10
		-- },
		-- [11] = {
		-- 	base_money = 4096000,
