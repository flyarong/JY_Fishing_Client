...
local TASK_TABLE = {
	[1] = {
		money = 180000, icon = "matchpop_icon_1", award = "0.8福利券", progress = 99,
	},
	[2] = {
		money = 580000, icon = "matchpop_icon_1", award = "1.8福利券", progress = 361,
	},
	[3] = {
		money = 1880000, icon = "matchpop_icon_1", award = "2.8福利券", progress = 623,
	},
	[4] = {
		money = 4880000, icon = "matchpop_icon_1", award = "4.8福利券", progress = 885,
	},
	[5] = {
		money = 18880000, icon = "matchpop_icon_1", award = "18福利券", progress = 1147,
	},
	[6] = {
