...
@interface UnityAppController : NSObject<UIApplicationDelegate, WXApiDelegate, UNUserNotificationCenterDelegate, AVAudioRecorderDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate,
