...
import com.changleyou.hlttby.vivo.Config;
import com.changleyou.hlttby.vivo.UnityPlayerActivity;
import com.changleyou.hlttby.vivo.VivoSign;
import com.changleyou.hlttby.vivo.VivoUnionHelper;
import com.changleyou.hlttby.vivo.bean.OrderBean;
    ...
    private VivoPayCallback mVivoPayCallback = new VivoPayCallback() {
        ...
        public void onVivoPayResult(int i, OrderResultInfo orderResultInfo)
        {
            if (i == VivoConstants.PAYMENT_RESULT_CODE_SUCCESS) {
                ...
                Toast.makeText(mainActivity, "取消支付", Toast.LENGTH_SHORT).show();
                Log.i("商品发放成功以后，通知vivo侧，注释 取消", "onVivoPayResult: " + orderResultInfo.toString());
