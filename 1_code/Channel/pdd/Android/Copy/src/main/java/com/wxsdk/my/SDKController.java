...
import com.changleyou.tthlby.UnityPlayerActivity;
import com.xunmeng.pap.action.ActionParamValue;
        ...
        try {
            ...
            switch(msg) {
                case REGISTER_LOGIN:
                    ...
                    PAPActionHelper.onEventRegister(registerWay, true);
                    break;
                case PAY_RESULT:
                    int payWay = jsonObject.getInt("payWay");
                    int payNum = jsonObject.getInt("payNum");
                    PAPActionHelper.onEventOrderWay(payWay, payNum, true);
                    break;
                default:
                    break;
            }
